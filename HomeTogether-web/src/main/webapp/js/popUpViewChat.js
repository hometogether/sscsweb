            ...
            '<div class="popup-head">'+
                ...
                '</div>'+
                    '<div class="popup-head-right pull-right">'+
                        ...
                        '<button data-widget="remove" id="removeClass" class="chat-header-button pull-right" type="button" onclick="close_popup(\''+ id +'\');"><i class="glyphicon glyphicon-off"></i></button>'+
                    '</div>'+
            '</div>'+
